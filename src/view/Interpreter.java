...
public class Interpreter {
    public static void main(String[] args){
        ...
        menu.addCommand(new RunExampleCommand("1", ex1.toString(), controller1,ex1));
        menu.addCommand(new RunExampleCommand("2", ex2.toString(), controller2,ex2));
        menu.addCommand(new RunExampleCommand("3", ex3.toString(), controller3,ex3));
        menu.addCommand(new RunExampleCommand("4", ex4.toString(), controller4,ex4));
        menu.addCommand(new RunExampleCommand("5", ex5.toString(), controller5,ex5));
        menu.addCommand(new RunExampleCommand("6", ex6.toString(), controller6,ex6));
        menu.addCommand(new RunExampleCommand("7", ex7.toString(), controller7,ex7));
        menu.addCommand(new RunExampleCommand("8", ex8.toString(), controller8,ex8));
        menu.addCommand(new RunExampleCommand("9", ex9.toString(), controller9,ex9));
        menu.addCommand(new RunExampleCommand("10", ex10.toString(), controller10,ex10));
        menu.show();
